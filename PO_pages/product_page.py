...
class ProductPage(BasePage):
    ...
    def check_add_to_cart(self, language): 
        text_check_add = self.translations.get(language, self.translations['en'])
        text_about_add = self.browser.find_element(*ProductPageLocators.succesfull_text).text
        assert text_check_add in text_about_add, 'Expected text {text_about_add}'
